          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="h-12 flex items-center">
                <Image src="/assets/Logo.png" alt="Dr. Pedro Assunção" width={100} height={40} className="object-contain" />
              </div>
      ...
      <section className="bg-gradient-to-br from-gray-50 via-white to-green-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 scroll-hidden">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-[#85927D] h-96">
              <Image src="/assets/foto3.png" alt="Dr. Pedro Assunção" className="object-cover w-full h-full" fill />
              <div className="absolute inset-0 bg-gradient-to-t from-[#5D6861]/30 to-transparent"></div>
              <div className="absolute bottom-6 left-6 text-white">
            ...
            <div className="scroll-slide-right">
              <div className="relative">
                ...
                <div className="relative bg-white rounded-3xl overflow-hidden shadow-2xl border-2 border-[#85927D]/20">
                  <Image src="/assets/foto2.png" alt="Dr. Pedro Assunção" className="object-cover w-full h-[600px]" fill />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:row-span-2">
              <div className="relative h-96 lg:h-full rounded-3xl overflow-hidden shadow-2xl border-2 border-white/20">
                <Image src="/assets/foto1.png" alt="Dr. Pedro Assunção com pacientes" className="object-cover w-full h-full" fill />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="group scroll-scale">
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 h-80">
                <Image src="/assets/foto1.png" alt="Dr. Pedro Assunção em atendimento" className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500" fill />
            ...
            <div className="group scroll-scale delay-200">
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 h-80">
                <Image src="/assets/foto2.png" alt="Dr. Pedro Assunção no consultório" className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500" fill />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                <div className="absolute bottom-6 left-6 text-white">
            ...
            <div className="group scroll-scale delay-400">
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 h-80">
                <Image src="/assets/foto3.png" alt="Dr. Pedro Assunção" className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500" fill />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                <div className="absolute bottom-6 left-6 text-white">
